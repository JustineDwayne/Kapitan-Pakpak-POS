        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            switch ((Result)e.Result)
            {
                ...
                case Result.WRONG_PASSWORD:
                    ...
                    MessageBox.Show("Contact me at my email: calma.justinedwayne.11232003@gmail.com" + Environment.NewLine + "to get the password");
                    Application.Exit();
                    break;
                case Result.DATABASE_ERROR:
                    MessageBox.Show("Oops!! There's a problem while connecting to the database.");
                    Application.Exit();
                    break;
            }
        }
